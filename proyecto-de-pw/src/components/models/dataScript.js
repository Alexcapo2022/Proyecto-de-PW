...
export const  graphicItems=[{
    ...
    "price":200,
    "img":`${RUTA_BACKEND}/imagenes/graphic.png`
},{
...
export const processorItems=[{
    "name":"Intel I3",
    "price":200,
    "img":`${RUTA_BACKEND}/imagenes/processor.png`
},{
    "name":"Intel I5",
    "price":200,
    "img":`${RUTA_BACKEND}/imagenes/processor.png`
...
export const memoryItems=[{
    "name":"RAM 4gb",
    "price":200,
    "img":`${RUTA_BACKEND}/imagenes/memory.png`
},{
    "name":"RAM 8gb",
    "price":200,
    "img":`${RUTA_BACKEND}/imagenes/memory.png`
...
export const storageItems=[{
    "name":"Toshiba 500GB",
    "price":200,
    "img":`${RUTA_BACKEND}/imagenes/storage.png`
},{
    "name":"Toshiba 1TB",
    "price":200,
    "img":`${RUTA_BACKEND}/imagenes/storage.png`
...
export const coolerItems=[{
    "name":"Cooler 10",
    "price":200,
    "img":`${RUTA_BACKEND}/imagenes/cooler.png`
},{
    "name":"Cooler 20",
    "price":200,
    "img":`${RUTA_BACKEND}/imagenes/cooler.png`
...
export const windowsItems=[{
    ...
    "price":200,
    "img":`${RUTA_BACKEND}/imagenes/windows.png`
},{
...
export const powersupplyItems=[{
    ...
    "price":200,
    "img":`${RUTA_BACKEND}/imagenes/power.png`
},{
