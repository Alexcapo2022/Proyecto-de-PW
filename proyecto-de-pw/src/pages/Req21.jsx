    ...
    <div className='container txt'>
      ...
      <div className='row pt-3'>
        <div className='col align-self-start bg-secondary px-0 mx-5 mb-5'>
          ...
          <div className='pt-3 bg-white'>
            <div className='d-inline p-2'>
              <img src={`/src/imagenes/HR/tecnonauta.jpg`} className='rounded-circle' height="40px" width={40} alt="" />
            </div>
        ...
        <div className='col align-self-start bg-secondary px-0 mx-5 mb-5'>
          ...
          <div className='pt-3 bg-white'>
            <div className='d-inline p-2'>
              <img src={`/src/imagenes/HR/varo.jpg`} className='rounded-circle' height="40px" width={40} alt="" />
            </div>
            <div className='d-inline px-2 fs-5 fw-bold descrip'>
              RINCÓN DE VARO
            </div>
